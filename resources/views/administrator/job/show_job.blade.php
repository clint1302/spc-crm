    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="#job_details" data-toggle="tab" aria-expanded="true">Job Details</a></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="job_details">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <tbody>
                            <tr>
                                <td width="25%"><strong>Job Name </strong></td>
                    ...
                    <div class="tab-pane" id="note">
                        ...
                        <form class="form-horizontal" action="{{ url('/jobs/notes/create/'. $job->id) }}" method="post">
                            ...
                            <!-- /.form group -->
                            <div class="form-group{{ $errors->has('remind_time') ? ' has-error' : '' }} has-feedback">
                                <div class="col-sm-12">
                                    <input type="text" name="remind_time" class="form-control" id="remind_time" value="{{ old('remind_time') }}" placeholder="Enter remind time.." required>
                            ...
                            <li>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body">
                                        <p><strong>Date: </strong>{{ date("d F Y", strtotime($note->remind_date)) }}</p>
                                        <p><strong>Time: </strong>{{ $note->remind_time }}</p>
                                        <p><strong>Note: </strong>{{ $note->note }}</p>
                                    </div>
                                        <div class="timeline-footer">
                                            <!--<a class="btn btn-primary btn-xs">Read more</a>-->
                                            <a href="{{ url('/jobs/notes/delete/'. $note->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete this ?');">Delete</a>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
