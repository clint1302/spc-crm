                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td class="text-center">
                                ...
                                <a href="{{ url('/jobs/unpublished/' . $job->id) }}" class="btn btn-success btn-xs btn-flat btn-block" data-toggle="tooltip" data-original-title="Click to unpublished"><i class="icon fa fa-arrow-down"> Published</i></a>
                                @else
                                <a href="{{ url('/jobs/published/' . $job->id) }}" class="btn btn-warning btn-xs btn-flat btn-block" data-toggle="tooltip" data-original-title="Click to published"><i class="icon fa fa-arrow-up"></i> Unpublished</a>
                                @endif
                            </td> 

                            <td class="text-center">
                                <a href="{{ url('/jobs/details/' . $job->id) }}" class="btn btn-default btn-xs btn-flat" data-toggle="tooltip" data-original-title="Click to payment details" style="background-color: #605ca8; color: #fff; border-color: #605ca8"><i class="icon fa fa-dollar"> Payment Details</i></a>
                            </td>-->
