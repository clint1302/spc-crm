...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/people/employees') }}">Employee</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('web') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="web" id="web" class="form-control" value="{{ $employee['web'] }}" placeholder="Enter web..">
                                @if ($errors->has('web'))
                                <span class="help-block">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('home_district') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="home_district" id="home_district" class="form-control" value="{{ $employee['home_district'] }}" placeholder="Enter home district..">
                            ...
                            <div class="form-group{{ $errors->has('id_number') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="id_number" id="id_number" class="form-control" value="{{ $employee['id_number'] }}" placeholder="Enter id number..">
