                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($client['activation_status'] == 1)
                                ...
                                <div class="form-group{{ $errors->has('contract_id_second') ? ' has-error' : '' }} has-feedback">
                                    <select name="contract_id_second" id="contract_id_second" class="form-control">
                                        <option value="" selected disabled>Select one</option>
                                        <option value="">No second contract</option>
                                        @foreach($client_contracts as $client_contract)
                                        <option value="{{ $client_contract['id'] }}" times="{{ $client_contract['time'] }}">{{ $client_contract['name'] }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('contract_id_second') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <!-- /.form-group -->
                            ...
                            <label for="enquiry_type">Enquiry Source <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('enquiry_type') ? ' has-error' : '' }} has-feedback">
                                ...
                                <span class="help-block">
                                    <strong>{{ $errors->first('enquiry_type') }}</strong>
                                </span>
                                @endif
                            </div>
                            <!-- /.form-group -->
...
<script type="text/javascript">
    ...
    document.forms['client_edit_form'].elements['enquiry_type'].value = "{{ $client['enquiry_type_id'] }}";
    <?php
        if($client['gender'] != ""){
            echo "document.forms['client_edit_form'].elements['gender'].value = '{$client["gender"]}';";
        }
        if($client['contract_id'] != ""){
            echo "document.forms['client_edit_form'].elements['contract_id'].value = '{$client["contract_id"]}';";
        }
        if($client['contract_id_second'] != ""){
            echo "document.forms['client_edit_form'].elements['contract_id_second'].value = '{$client["contract_id_second"]}';";
        }
    ?>
