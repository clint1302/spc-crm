    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body" style="overflow:auto;">
                ...
                @permission('manage-clients-full')
                <a href="{{ url('/people/clients/create') }}" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add client</a>
                <a href="{{ url('/people/clients/print') }}" class="tip btn btn-info btn-flat pull-right" title="Print" data-original-title="Label Printer"> <i class="fa fa-print"></i><span class="hidden-sm hidden-xs"> Print</span></a>
                <!--<a href="{{ url('/people/clients/clients-pdf') }}" class="tip btn btn-default btn-flat pull-right" title="PDF" data-original-title="Label Printer"> <i class="fa fa-file-pdf-o"></i><span class="hidden-sm hidden-xs"> PDF</span></a>-->
                @endpermission
