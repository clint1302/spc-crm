<style>
.skin-purple-light .main-header .navbar .sidebar-toggle:hover{background-color:#1c68b5;}
</style>
<header class="main-header" style="background-color:#237bd4;">
    <!-- Logo -->
    <a href="{{ url('/dashboard') }}" class="logo" style="background-color:#237bd4;">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>SPC - CRM</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>SPC - CRM</b></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="background-color:#237bd4;">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header" style="background-color:#237bd4;">
                            @if(!empty(auth()->user()->avatar))
